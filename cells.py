...
class Cells:
    ...
    def colorCell(self, win, color, shape):
        ...
        if shape == "node":
            pygame.draw.circle(win, color, (self.x_pos*side+3, self.y_pos*side+3), side//3) # draws the node in the correct location
        ...
        # checks if it is supposed to draw a circle
            ...
            pygame.draw.circle(win, color, (self.x_pos*side+3, self.y_pos*side+3), side//12) # draws the circle in the correct location